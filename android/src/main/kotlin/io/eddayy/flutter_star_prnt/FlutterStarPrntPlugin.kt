...
public class FlutterStarPrntPlugin : FlutterPlugin, MethodCallHandler {
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "app.condominios/impresora")
    ...
    fun setupPlugin(messenger: BinaryMessenger, context: Context) {
      try {
        ...
        val channel = MethodChannel(messenger, "app.condominios/impresora")
        channel.setMethodCallHandler(FlutterStarPrntPlugin())
      } catch (e: Exception) {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    val channel = MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "app.condominios/impresora")
    channel.setMethodCallHandler(FlutterStarPrntPlugin())
